...
{
    /// <summary>
    /// Standard barchart data object for streaming barchart data with stream/barchart/...
    /// </summary>
    [DataContract]
    public partial class BarchartDefinition :  IEquatable<BarchartDefinition>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BarchartDefinition" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BarchartDefinition() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BarchartDefinition" /> class.
        /// </summary>
        /// <param name="close">Close price of current bar. (required).</param>
        /// <param name="downTicks">A trade made at a price less than the previous trade price or at a price equal to the previous trade price.. (required).</param>
        /// <param name="downVolume">The volume of securities with a current price that is below the previous day&#x60;s close (required).</param>
        /// <param name="high">High price of current bar. (required).</param>
        /// <param name="low">Low price of current bar. (required).</param>
        /// <param name="open">Open price of current bar. (required).</param>
        /// <param name="openInterest">Number of open contracts. (required).</param>
        /// <param name="status">status (required).</param>
        /// <param name="timeStamp">Epoch timestamp. (required).</param>
        /// <param name="totalTicks">Total number of ticks (upticks and downticks together). (required).</param>
        /// <param name="totalVolume">The total volume of all securities trading on a specific exchange. (required).</param>
        /// <param name="unchangedTicks">The number of securities with a current price that is the same as the previous day&#x60;s close (required).</param>
        /// <param name="unchangedVolume">The volume of securities with a current price that is the same as the previous day&#x60;s close. (required).</param>
        /// <param name="upTicks">A trade made at a price greater than the previous trade price, or at a price equal to the previous trade price. (required).</param>
        /// <param name="upVolume">The volume of securities with a current price that is above the previous day&#x60;s close. (required).</param>
        public BarchartDefinition(decimal? close = default(decimal?), decimal? downTicks = default(decimal?), decimal? downVolume = default(decimal?), decimal? high = default(decimal?), decimal? low = default(decimal?), decimal? open = default(decimal?), decimal? openInterest = default(decimal?), /*StatusDefinition*/int? status = default(/*StatusDefinition*/int?), string timeStamp = default(string), decimal? totalTicks = default(decimal?), decimal? totalVolume = default(decimal?), decimal? unchangedTicks = default(decimal?), decimal? unchangedVolume = default(decimal?), decimal? upTicks = default(decimal?), decimal? upVolume = default(decimal?))
        {
            // to ensure "close" is required (not null)
            if (close == null)
            {
                throw new InvalidDataException("close is a required property for BarchartDefinition and cannot be null");
            }
            else
            {
                this.Close = close;
            ...
            if (downTicks == null)
            {
                throw new InvalidDataException("downTicks is a required property for BarchartDefinition and cannot be null");
            }
            else
            {
            ...
            if (downVolume == null)
            {
                throw new InvalidDataException("downVolume is a required property for BarchartDefinition and cannot be null");
            }
            else
            {
            ...
            if (high == null)
            {
                throw new InvalidDataException("high is a required property for BarchartDefinition and cannot be null");
            }
            else
            {
                this.High = high;
            ...
            if (low == null)
            {
                throw new InvalidDataException("low is a required property for BarchartDefinition and cannot be null");
            }
            else
            {
                this.Low = low;
            ...
            if (open == null)
            {
                throw new InvalidDataException("open is a required property for BarchartDefinition and cannot be null");
            }
            else
            {
                this.Open = open;
            ...
            {
                throw new InvalidDataException("openInterest is a required property for BarchartDefinition and cannot be null");
            }
            else
            {
            ...
            if (status == null)
            {
                throw new InvalidDataException("status is a required property for BarchartDefinition and cannot be null");
            }
            else
            {
                this.Status = status;
            ...
            if (timeStamp == null)
            {
                throw new InvalidDataException("timeStamp is a required property for BarchartDefinition and cannot be null");
            }
            else
            {
                this.TimeStamp = timeStamp;
            }
            // to ensure "totalTicks" is required (not null)
            if (totalTicks == null)
            {
                throw new InvalidDataException("totalTicks is a required property for BarchartDefinition and cannot be null");
            }
            else
            {
                this.TotalTicks = totalTicks;
            }
            // to ensure "totalVolume" is required (not null)
            if (totalVolume == null)
            {
                throw new InvalidDataException("totalVolume is a required property for BarchartDefinition and cannot be null");
            }
            else
            {
                this.TotalVolume = totalVolume;
            }
            // to ensure "unchangedTicks" is required (not null)
            if (unchangedTicks == null)
            {
                throw new InvalidDataException("unchangedTicks is a required property for BarchartDefinition and cannot be null");
            }
            else
            {
                this.UnchangedTicks = unchangedTicks;
            }
            // to ensure "unchangedVolume" is required (not null)
            if (unchangedVolume == null)
            {
                throw new InvalidDataException("unchangedVolume is a required property for BarchartDefinition and cannot be null");
            }
            else
            {
            ...
            if (upTicks == null)
            {
                throw new InvalidDataException("upTicks is a required property for BarchartDefinition and cannot be null");
            }
            else
            {
            ...
            if (upVolume == null)
            {
                throw new InvalidDataException("upVolume is a required property for BarchartDefinition and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>Close price of current bar.</value>
        ...
        /// </summary>
        /// <value>A trade made at a price less than the previous trade price or at a price equal to the previous trade price..</value>
        [DataMember(Name="DownTicks", EmitDefaultValue=false)]
        public decimal? DownTicks { get; set; }

        /// <summary>
        /// The volume of securities with a current price that is below the previous day&#x60;s close
        /// </summary>
        /// <value>The volume of securities with a current price that is below the previous day&#x60;s close</value>
        ...
        /// </summary>
        /// <value>High price of current bar.</value>
        ...
        /// </summary>
        /// <value>Low price of current bar.</value>
        ...
        /// </summary>
        /// <value>Open price of current bar.</value>
        ...
        /// </summary>
        /// <value>Number of open contracts.</value>
        ...
        /// </summary>
        /// <value>Total number of ticks (upticks and downticks together).</value>
        [DataMember(Name="TotalTicks", EmitDefaultValue=false)]
        public decimal? TotalTicks { get; set; }

        /// <summary>
        /// The total volume of all securities trading on a specific exchange.
        /// </summary>
        /// <value>The total volume of all securities trading on a specific exchange.</value>
        [DataMember(Name="TotalVolume", EmitDefaultValue=false)]
        public decimal? TotalVolume { get; set; }

        /// <summary>
        /// The number of securities with a current price that is the same as the previous day&#x60;s close
        /// </summary>
        /// <value>The number of securities with a current price that is the same as the previous day&#x60;s close</value>
        [DataMember(Name="UnchangedTicks", EmitDefaultValue=false)]
        public decimal? UnchangedTicks { get; set; }

        /// <summary>
        /// The volume of securities with a current price that is the same as the previous day&#x60;s close.
        /// </summary>
        /// <value>The volume of securities with a current price that is the same as the previous day&#x60;s close.</value>
        [DataMember(Name="UnchangedVolume", EmitDefaultValue=false)]
        public decimal? UnchangedVolume { get; set; }

        /// <summary>
        /// A trade made at a price greater than the previous trade price, or at a price equal to the previous trade price.
        /// </summary>
        /// <value>A trade made at a price greater than the previous trade price, or at a price equal to the previous trade price.</value>
        [DataMember(Name="UpTicks", EmitDefaultValue=false)]
        public decimal? UpTicks { get; set; }

        /// <summary>
        /// The volume of securities with a current price that is above the previous day&#x60;s close.
        /// </summary>
        /// <value>The volume of securities with a current price that is above the previous day&#x60;s close.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BarchartDefinition {\n");
            ...
            sb.Append("  UnchangedTicks: ").Append(UnchangedTicks).Append("\n");
            sb.Append("  UnchangedVolume: ").Append(UnchangedVolume).Append("\n");
        ...
        {
            return this.Equals(input as BarchartDefinition);
        }

        /// <summary>
        /// Returns true if BarchartDefinition instances are equal
        /// </summary>
        /// <param name="input">Instance of BarchartDefinition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BarchartDefinition input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.UnchangedTicks == input.UnchangedTicks ||
                    (this.UnchangedTicks != null &&
                    this.UnchangedTicks.Equals(input.UnchangedTicks))
                ) && 
                (
                    this.UnchangedVolume == input.UnchangedVolume ||
                    (this.UnchangedVolume != null &&
                    this.UnchangedVolume.Equals(input.UnchangedVolume))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.UnchangedTicks != null)
                    hashCode = hashCode * 59 + this.UnchangedTicks.GetHashCode();
                if (this.UnchangedVolume != null)
                    hashCode = hashCode * 59 + this.UnchangedVolume.GetHashCode();
