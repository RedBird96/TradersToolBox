...
namespace TradeStationAPI.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BarchartError400 :  IEquatable<BarchartError400>, IValidatableObject
    {
        /// <summary>
        /// Defines Message
        /// </summary>
        ...
        public enum MessageEnum
        {
            ...
            /// <summary>
            /// Enum Date for value: Not a valid date.
            /// </summary>
            [EnumMember(Value = "Not a valid date.")]
            Date = 1,
            
            /// <summary>
            /// Enum Number for value: Not a valid number.
            /// </summary>
            [EnumMember(Value = "Not a valid number.")]
            Number = 2
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BarchartError400" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BarchartError400() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BarchartError400" /> class.
        /// </summary>
        /// <param name="statusCode">statusCode (required).</param>
        /// <param name="message">message (required).</param>
        public BarchartError400(int? statusCode = default(int?), MessageEnum message = default(MessageEnum))
        {
            // to ensure "statusCode" is required (not null)
            if (statusCode == null)
            {
                throw new InvalidDataException("statusCode is a required property for BarchartError400 and cannot be null");
            }
            else
            {
            ...
            if (message == null)
            {
                throw new InvalidDataException("message is a required property for BarchartError400 and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BarchartError400 {\n");
        ...
        {
            return this.Equals(input as BarchartError400);
        }

        /// <summary>
        /// Returns true if BarchartError400 instances are equal
        /// </summary>
        /// <param name="input">Instance of BarchartError400 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BarchartError400 input)
        {
            if (input == null)
                return false;
