...
namespace TradeStationAPI.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GroupOrderConfirmRequestDefinition :  IEquatable<GroupOrderConfirmRequestDefinition>, IValidatableObject
    {
        /// <summary>
        /// Indicates how Order Execution should treat this group of orders. 
        /// </summary>
        /// <value>Indicates how Order Execution should treat this group of orders. </value>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GroupOrderConfirmRequestDefinition" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GroupOrderConfirmRequestDefinition() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GroupOrderConfirmRequestDefinition" /> class.
        /// </summary>
        /// <param name="orders">orders (required).</param>
        /// <param name="type">Indicates how Order Execution should treat this group of orders.  (required).</param>
        public GroupOrderConfirmRequestDefinition(List<OrderConfirmRequestDefinition> orders = default(List<OrderConfirmRequestDefinition>), TypeEnum type = default(TypeEnum))
        {
            // to ensure "orders" is required (not null)
            if (orders == null)
            {
                throw new InvalidDataException("orders is a required property for GroupOrderConfirmRequestDefinition and cannot be null");
            }
            else
            {
                this.Orders = orders;
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for GroupOrderConfirmRequestDefinition and cannot be null");
            }
            else
            {
                this.Type = type;
        ...
        public List<OrderConfirmRequestDefinition> Orders { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GroupOrderConfirmRequestDefinition {\n");
        ...
        {
            return this.Equals(input as GroupOrderConfirmRequestDefinition);
        }

        /// <summary>
        /// Returns true if GroupOrderConfirmRequestDefinition instances are equal
        /// </summary>
        /// <param name="input">Instance of GroupOrderConfirmRequestDefinition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GroupOrderConfirmRequestDefinition input)
        {
            if (input == null)
                return false;
