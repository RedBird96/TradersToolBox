...
namespace TradeStationAPI.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TickbarDefinition :  IEquatable<TickbarDefinition>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TickbarDefinition" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TickbarDefinition() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TickbarDefinition" /> class.
        /// </summary>
        ...
        public TickbarDefinition(decimal? close = default(decimal?), StatusDefinition status = default(StatusDefinition), string timeStamp = default(string), decimal? totalVolume = default(decimal?))
        {
            // to ensure "close" is required (not null)
            if (close == null)
            {
                throw new InvalidDataException("close is a required property for TickbarDefinition and cannot be null");
            }
            else
            {
                this.Close = close;
            ...
            if (status == null)
            {
                throw new InvalidDataException("status is a required property for TickbarDefinition and cannot be null");
            }
            else
            {
                this.Status = status;
            ...
            if (timeStamp == null)
            {
                throw new InvalidDataException("timeStamp is a required property for TickbarDefinition and cannot be null");
            }
            else
            {
            ...
            if (totalVolume == null)
            {
                throw new InvalidDataException("totalVolume is a required property for TickbarDefinition and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TickbarDefinition {\n");
        ...
        {
            return this.Equals(input as TickbarDefinition);
        }

        /// <summary>
        /// Returns true if TickbarDefinition instances are equal
        /// </summary>
        /// <param name="input">Instance of TickbarDefinition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TickbarDefinition input)
        {
            if (input == null)
                return false;
