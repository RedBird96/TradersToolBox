...
namespace TradeStationAPI.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SymbolSuggestDefinition : List<SymbolSuggestDefinitionInner>,  IEquatable<SymbolSuggestDefinition>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SymbolSuggestDefinition" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public SymbolSuggestDefinition() : base()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SymbolSuggestDefinition {\n");
        ...
        {
            return this.Equals(input as SymbolSuggestDefinition);
        }

        /// <summary>
        /// Returns true if SymbolSuggestDefinition instances are equal
        /// </summary>
        /// <param name="input">Instance of SymbolSuggestDefinition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SymbolSuggestDefinition input)
        {
            if (input == null)
                return false;
