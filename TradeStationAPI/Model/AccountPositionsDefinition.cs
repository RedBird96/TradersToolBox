...
namespace TradeStationAPI.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AccountPositionsDefinition : List<AccountPositionsDefinitionInner>,  IEquatable<AccountPositionsDefinition>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountPositionsDefinition" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public AccountPositionsDefinition() : base()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccountPositionsDefinition {\n");
        ...
        {
            return this.Equals(input as AccountPositionsDefinition);
        }

        /// <summary>
        /// Returns true if AccountPositionsDefinition instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountPositionsDefinition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountPositionsDefinition input)
        {
            if (input == null)
                return false;
