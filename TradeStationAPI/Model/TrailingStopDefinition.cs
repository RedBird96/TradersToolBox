...
{
    /// <summary>
    /// Trailing Stop offset; amount or percent
    /// </summary>
    [DataContract]
    public partial class TrailingStopDefinition :  IEquatable<TrailingStopDefinition>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrailingStopDefinition" /> class.
        /// </summary>
        /// <param name="amount">Currency Offset from current price. Note: Mutually exclusive with Percent. .</param>
        /// <param name="percent">Percentage offset from current price. Note: Mutually exclusive with Amount. .</param>
        public TrailingStopDefinition(decimal? amount = default(decimal?), decimal? percent = default(decimal?))
        {
            this.Amount = amount;
        ...
        /// </summary>
        /// <value>Currency Offset from current price. Note: Mutually exclusive with Percent. </value>
        ...
        /// </summary>
        /// <value>Percentage offset from current price. Note: Mutually exclusive with Amount. </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrailingStopDefinition {\n");
        ...
        {
            return this.Equals(input as TrailingStopDefinition);
        }

        /// <summary>
        /// Returns true if TrailingStopDefinition instances are equal
        /// </summary>
        /// <param name="input">Instance of TrailingStopDefinition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrailingStopDefinition input)
        {
            if (input == null)
                return false;
