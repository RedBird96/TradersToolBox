...
namespace TradeStationAPI.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OrderConfirmRequestDefinition :  IEquatable<OrderConfirmRequestDefinition>, IValidatableObject
    {
        /// <summary>
        /// Defines AssetType
        /// </summary>
        ...
        public enum RouteEnum
        {
            ...
            /// <summary>
            /// Enum BTRD for value: BTRD
            /// </summary>
            [EnumMember(Value = "BTRD")]
            BTRD = 6,
            ...
            /// <summary>
            /// Enum GFLO for value: GFLO
            /// </summary>
            [EnumMember(Value = "GFLO")]
            GFLO = 11,
            
            /// <summary>
            /// Enum MIXI for value: MIXI
            /// </summary>
            [EnumMember(Value = "MIXI")]
            MIXI = 12,
            
            /// <summary>
            /// Enum NITE for value: NITE
            /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OrderConfirmRequestDefinition" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected OrderConfirmRequestDefinition() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OrderConfirmRequestDefinition" /> class.
        /// </summary>
        ...
        public OrderConfirmRequestDefinition(string accountKey = default(string), AdvancedOptionsDefinition advancedOptions = default(AdvancedOptionsDefinition), AssetTypeEnum assetType = default(AssetTypeEnum), DurationEnum duration = default(DurationEnum), string gTDDate = default(string), string limitPrice = default(string), string stopPrice = default(string), OrderTypeEnum orderType = default(OrderTypeEnum), string quantity = default(string), RouteEnum? route = default(RouteEnum?), string symbol = default(string), TradeActionEnum tradeAction = default(TradeActionEnum), List<OrderConfirmRequestDefinitionOSOs> oSOs = default(List<OrderConfirmRequestDefinitionOSOs>), List<OrderConfirmRequestDefinitionLegs> legs = default(List<OrderConfirmRequestDefinitionLegs>))
        {
            // to ensure "accountKey" is required (not null)
            if (accountKey == null)
            {
                throw new InvalidDataException("accountKey is a required property for OrderConfirmRequestDefinition and cannot be null");
            }
            else
            {
            ...
            if (assetType == null)
            {
                throw new InvalidDataException("assetType is a required property for OrderConfirmRequestDefinition and cannot be null");
            }
            else
            {
            ...
            if (duration == null)
            {
                throw new InvalidDataException("duration is a required property for OrderConfirmRequestDefinition and cannot be null");
            }
            else
            {
            ...
            if (orderType == null)
            {
                throw new InvalidDataException("orderType is a required property for OrderConfirmRequestDefinition and cannot be null");
            }
            else
            {
            ...
            if (quantity == null)
            {
                throw new InvalidDataException("quantity is a required property for OrderConfirmRequestDefinition and cannot be null");
            }
            else
            {
            ...
            if (symbol == null)
            {
                throw new InvalidDataException("symbol is a required property for OrderConfirmRequestDefinition and cannot be null");
            }
            else
            {
                this.Symbol = symbol;
            ...
            if (tradeAction == null)
            {
                throw new InvalidDataException("tradeAction is a required property for OrderConfirmRequestDefinition and cannot be null");
            }
            else
            {
        ...
        public List<OrderConfirmRequestDefinitionOSOs> OSOs { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OrderConfirmRequestDefinition {\n");
        ...
        {
            return this.Equals(input as OrderConfirmRequestDefinition);
        }

        /// <summary>
        /// Returns true if OrderConfirmRequestDefinition instances are equal
        /// </summary>
        /// <param name="input">Instance of OrderConfirmRequestDefinition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrderConfirmRequestDefinition input)
        {
            if (input == null)
                return false;
