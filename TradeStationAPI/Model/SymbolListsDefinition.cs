...
namespace TradeStationAPI.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SymbolListsDefinition : List<SymbolListDefinition>,  IEquatable<SymbolListsDefinition>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SymbolListsDefinition" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public SymbolListsDefinition() : base()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SymbolListsDefinition {\n");
        ...
        {
            return this.Equals(input as SymbolListsDefinition);
        }

        /// <summary>
        /// Returns true if SymbolListsDefinition instances are equal
        /// </summary>
        /// <param name="input">Instance of SymbolListsDefinition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SymbolListsDefinition input)
        {
            if (input == null)
                return false;
