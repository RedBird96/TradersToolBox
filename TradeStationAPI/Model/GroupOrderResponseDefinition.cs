...
namespace TradeStationAPI.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GroupOrderResponseDefinition : List<OrderResponseDefinition>,  IEquatable<GroupOrderResponseDefinition>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GroupOrderResponseDefinition" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public GroupOrderResponseDefinition() : base()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GroupOrderResponseDefinition {\n");
        ...
        {
            return this.Equals(input as GroupOrderResponseDefinition);
        }

        /// <summary>
        /// Returns true if GroupOrderResponseDefinition instances are equal
        /// </summary>
        /// <param name="input">Instance of GroupOrderResponseDefinition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GroupOrderResponseDefinition input)
        {
            if (input == null)
                return false;
