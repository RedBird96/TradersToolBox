...
namespace TradeStationAPI.Model
{
    ...
    public partial class InlineResponse200 :  IEquatable<InlineResponse200>, IValidatableObject
    {
        ...
        public InlineResponse200(List<ActivationTriggerDefinition> activationTriggers = default(List<ActivationTriggerDefinition>))
        {
        ...
        public List<ActivationTriggerDefinition> ActivationTriggers { get; set; }
        ...
        public bool Equals(InlineResponse200 input)
        {
            ...
            return 
                (
                    this.ActivationTriggers == input.ActivationTriggers ||
                    this.ActivationTriggers != null &&
                    this.ActivationTriggers.SequenceEqual(input.ActivationTriggers)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ActivationTriggers != null)
                    hashCode = hashCode * 59 + this.ActivationTriggers.GetHashCode();
                return hashCode;
            }
        }
