...
{
    /// <summary>
    /// Quote object used in data/quote
    /// </summary>
    [DataContract]
    public partial class QuoteDefinition : List<QuoteDefinitionInner>,  IEquatable<QuoteDefinition>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QuoteDefinition" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public QuoteDefinition() : base()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class QuoteDefinition {\n");
        ...
        {
            return this.Equals(input as QuoteDefinition);
        }

        /// <summary>
        /// Returns true if QuoteDefinition instances are equal
        /// </summary>
        /// <param name="input">Instance of QuoteDefinition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QuoteDefinition input)
        {
            if (input == null)
                return false;
