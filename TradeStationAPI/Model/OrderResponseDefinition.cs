...
namespace TradeStationAPI.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OrderResponseDefinition :  IEquatable<OrderResponseDefinition>, IValidatableObject
    {
        /// <summary>
        /// Returns the status of the order operation
        /// </summary>
        /// <value>Returns the status of the order operation</value>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OrderResponseDefinition" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected OrderResponseDefinition() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OrderResponseDefinition" /> class.
        /// </summary>
        /// <param name="message">Message string returned from orders service. (required).</param>
        /// <param name="orderID">Identifier for order..</param>
        /// <param name="orderStatus">Returns the status of the order operation (required).</param>
        public OrderResponseDefinition(string message = default(string), string orderID = default(string), OrderStatusEnum orderStatus = default(OrderStatusEnum))
        {
            // to ensure "message" is required (not null)
            if (message == null)
            {
                throw new InvalidDataException("message is a required property for OrderResponseDefinition and cannot be null");
            }
            else
            {
            ...
            if (orderStatus == null)
            {
                throw new InvalidDataException("orderStatus is a required property for OrderResponseDefinition and cannot be null");
            }
            else
            {
        ...
        /// <summary>
        /// Message string returned from orders service.
        /// </summary>
        /// <value>Message string returned from orders service.</value>
        ...
        /// </summary>
        /// <value>Identifier for order.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OrderResponseDefinition {\n");
        ...
        {
            return this.Equals(input as OrderResponseDefinition);
        }

        /// <summary>
        /// Returns true if OrderResponseDefinition instances are equal
        /// </summary>
        /// <param name="input">Instance of OrderResponseDefinition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrderResponseDefinition input)
        {
            if (input == null)
                return false;
