...
namespace TradeStationAPI.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BarchartError404 :  IEquatable<BarchartError404>, IValidatableObject
    {
        /// <summary>
        /// Defines Message
        /// </summary>
        ...
        public enum MessageEnum
        {
            ...
            /// <summary>
            /// Enum INVALIDSYMBOL for value: INVALID SYMBOL
            /// </summary>
            [EnumMember(Value = "INVALID SYMBOL")]
            INVALIDSYMBOL = 1,
            
            /// <summary>
            /// Enum Invalidbarintervalquantity for value: Invalid bar interval quantity.
            /// </summary>
            [EnumMember(Value = "Invalid bar interval quantity.")]
            Invalidbarintervalquantity = 2,
            
            /// <summary>
            /// Enum Invalidbarintervalunit for value: Invalid bar interval unit.
            /// </summary>
            [EnumMember(Value = "Invalid bar interval unit.")]
            Invalidbarintervalunit = 3,
            ...
            /// <summary>
            /// Enum Startdatecannotbeearlierthan111900 for value: Start date can not be earlier than 1/1/1900
            /// </summary>
            [EnumMember(Value = "Start date can not be earlier than 1/1/1900")]
            Startdatecannotbeearlierthan111900 = 6,
            
            /// <summary>
            /// Enum Enddatecannotbeearlierthanstartdate for value: End date cannot be earlier than start date.
            /// </summary>
            [EnumMember(Value = "End date cannot be earlier than start date.")]
            Enddatecannotbeearlierthanstartdate = 7
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BarchartError404" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BarchartError404() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BarchartError404" /> class.
        /// </summary>
        /// <param name="statusCode">statusCode (required).</param>
        /// <param name="message">message (required).</param>
        public BarchartError404(int? statusCode = default(int?), MessageEnum message = default(MessageEnum))
        {
            // to ensure "statusCode" is required (not null)
            if (statusCode == null)
            {
                throw new InvalidDataException("statusCode is a required property for BarchartError404 and cannot be null");
            }
            else
            {
            ...
            if (message == null)
            {
                throw new InvalidDataException("message is a required property for BarchartError404 and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BarchartError404 {\n");
        ...
        {
            return this.Equals(input as BarchartError404);
        }

        /// <summary>
        /// Returns true if BarchartError404 instances are equal
        /// </summary>
        /// <param name="input">Instance of BarchartError404 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BarchartError404 input)
        {
            if (input == null)
                return false;
