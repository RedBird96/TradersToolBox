...
namespace TradeStationAPI.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SymbolListSymbolsDefinition : List<SymbolListSymbolsDefinitionInner>,  IEquatable<SymbolListSymbolsDefinition>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SymbolListSymbolsDefinition" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public SymbolListSymbolsDefinition() : base()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SymbolListSymbolsDefinition {\n");
        ...
        {
            return this.Equals(input as SymbolListSymbolsDefinition);
        }

        /// <summary>
        /// Returns true if SymbolListSymbolsDefinition instances are equal
        /// </summary>
        /// <param name="input">Instance of SymbolListSymbolsDefinition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SymbolListSymbolsDefinition input)
        {
            if (input == null)
                return false;
