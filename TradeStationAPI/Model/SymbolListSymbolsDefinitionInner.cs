...
{
    /// <summary>
    /// SymbolListSymbolsDefinitionInner
    /// </summary>
    [DataContract]
    public partial class SymbolListSymbolsDefinitionInner :  IEquatable<SymbolListSymbolsDefinitionInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SymbolListSymbolsDefinitionInner" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SymbolListSymbolsDefinitionInner() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SymbolListSymbolsDefinitionInner" /> class.
        /// </summary>
        ...
        public SymbolListSymbolsDefinitionInner(string description = default(string), string exchange = default(string), string name = default(string))
        {
            // to ensure "description" is required (not null)
            if (description == null)
            {
                throw new InvalidDataException("description is a required property for SymbolListSymbolsDefinitionInner and cannot be null");
            }
            else
            {
            ...
            if (exchange == null)
            {
                throw new InvalidDataException("exchange is a required property for SymbolListSymbolsDefinitionInner and cannot be null");
            }
            else
            {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for SymbolListSymbolsDefinitionInner and cannot be null");
            }
            else
            {
                this.Name = name;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SymbolListSymbolsDefinitionInner {\n");
        ...
        {
            return this.Equals(input as SymbolListSymbolsDefinitionInner);
        }

        /// <summary>
        /// Returns true if SymbolListSymbolsDefinitionInner instances are equal
        /// </summary>
        /// <param name="input">Instance of SymbolListSymbolsDefinitionInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SymbolListSymbolsDefinitionInner input)
        {
            if (input == null)
                return false;
