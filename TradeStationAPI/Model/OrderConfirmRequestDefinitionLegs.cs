...
{
    /// <summary>
    /// OrderConfirmRequestDefinitionLegs
    /// </summary>
    [DataContract]
    public partial class OrderConfirmRequestDefinitionLegs :  IEquatable<OrderConfirmRequestDefinitionLegs>, IValidatableObject
    {
        /// <summary>
        /// Conveys the intent of the trade * BUY - equity and futures trades * SELL - equity and futures trades * BUYTOCOVER - equity trade to close a short position * SELLSHORT - equity trade to open a short position * BUYTOOPEN - option trades * BUYTOCLOSE - option trades * SELLTOOPEN - option trades * SELLTOCLOSE - option trades 
        /// </summary>
        /// <value>Conveys the intent of the trade * BUY - equity and futures trades * SELL - equity and futures trades * BUYTOCOVER - equity trade to close a short position * SELLSHORT - equity trade to open a short position * BUYTOOPEN - option trades * BUYTOCLOSE - option trades * SELLTOOPEN - option trades * SELLTOCLOSE - option trades </value>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OrderConfirmRequestDefinitionLegs" /> class.
        /// </summary>
        /// <param name="symbol">Must be UPPERCASE.</param>
        /// <param name="quantity">quantity.</param>
        /// <param name="tradeAction">Conveys the intent of the trade * BUY - equity and futures trades * SELL - equity and futures trades * BUYTOCOVER - equity trade to close a short position * SELLSHORT - equity trade to open a short position * BUYTOOPEN - option trades * BUYTOCLOSE - option trades * SELLTOOPEN - option trades * SELLTOCLOSE - option trades .</param>
        public OrderConfirmRequestDefinitionLegs(string symbol = default(string), string quantity = default(string), TradeActionEnum? tradeAction = default(TradeActionEnum?))
        {
            this.Symbol = symbol;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OrderConfirmRequestDefinitionLegs {\n");
        ...
        {
            return this.Equals(input as OrderConfirmRequestDefinitionLegs);
        }

        /// <summary>
        /// Returns true if OrderConfirmRequestDefinitionLegs instances are equal
        /// </summary>
        /// <param name="input">Instance of OrderConfirmRequestDefinitionLegs to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrderConfirmRequestDefinitionLegs input)
        {
            if (input == null)
                return false;
