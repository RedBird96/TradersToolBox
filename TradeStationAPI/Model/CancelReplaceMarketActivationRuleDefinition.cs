...
namespace TradeStationAPI.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CancelReplaceMarketActivationRuleDefinition :  IEquatable<CancelReplaceMarketActivationRuleDefinition>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CancelReplaceMarketActivationRuleDefinition" /> class.
        /// </summary>
        /// <param name="clearAll">If &#39;True&#39;, removes all activation rules when replacing the order and ignores any rules sent in &#x60;Rules&#x60;. .</param>
        /// <param name="rules">Set of market-based activation rules that must be met before order is sent to the exchange. Max 4 rules. .</param>
        public CancelReplaceMarketActivationRuleDefinition(bool? clearAll = default(bool?), List<MarketActivationRuleDefinition> rules = default(List<MarketActivationRuleDefinition>))
        {
        ...
        /// </summary>
        /// <value>If &#39;True&#39;, removes all activation rules when replacing the order and ignores any rules sent in &#x60;Rules&#x60;. </value>
        ...
        public List<MarketActivationRuleDefinition> Rules { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CancelReplaceMarketActivationRuleDefinition {\n");
        ...
        {
            return this.Equals(input as CancelReplaceMarketActivationRuleDefinition);
        }

        /// <summary>
        /// Returns true if CancelReplaceMarketActivationRuleDefinition instances are equal
        /// </summary>
        /// <param name="input">Instance of CancelReplaceMarketActivationRuleDefinition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CancelReplaceMarketActivationRuleDefinition input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.ClearAll == input.ClearAll ||
                    (this.ClearAll != null &&
                    this.ClearAll.Equals(input.ClearAll))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ClearAll != null)
                    hashCode = hashCode * 59 + this.ClearAll.GetHashCode();
                if (this.Rules != null)
