...
namespace TradeStationAPI.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SymbolDefinition :  IEquatable<SymbolDefinition>, IValidatableObject
    {
        /// <summary>
        ...
        public enum ExchangeEnum
        {
            ...
            /// <summary>
            /// Enum OTCBBAMEX for value: OTCBB AMEX
            /// </summary>
            [EnumMember(Value = "OTCBB AMEX")]
            OTCBBAMEX = 4,
            
            /// <summary>
            /// Enum ARCX for value: ARCX
            /// </summary>
            [EnumMember(Value = "ARCX")]
            ARCX = 5,
            
            /// <summary>
            /// Enum NASDS for value: NASDS
            /// </summary>
            [EnumMember(Value = "NASDS")]
            NASDS = 6,
            
            /// <summary>
            /// Enum EUREX for value: EUREX
            /// </summary>
            [EnumMember(Value = "EUREX")]
            EUREX = 7,
            ...
            /// <summary>
            /// Enum ONCH for value: ONCH
            /// </summary>
            [EnumMember(Value = "ONCH")]
            ONCH = 10,
            
            /// <summary>
            /// Enum NYMEX for value: NYMEX
            /// </summary>
            [EnumMember(Value = "NYMEX")]
            NYMEX = 11,
            
            /// <summary>
            /// Enum CBOT for value: CBOT
            /// </summary>
            [EnumMember(Value = "CBOT")]
            CBOT = 12
        }
        ...
        /// <param name="country">The country of the exchange where the symbol is listed..</param>
        ...
        public SymbolDefinition(string category = default(string), CountryEnum? country = default(CountryEnum?), CurrencyEnum currency = default(CurrencyEnum), string description = default(string), decimal? displayType = default(decimal?), string error = default(string), ExchangeEnum exchange = default(ExchangeEnum), decimal? exchangeID = default(decimal?), string expirationDate = default(string), string expirationType = default(string), string futureType = default(string), string industryCode = default(string), string industryName = default(string), decimal? lotSize = default(decimal?), decimal? minMove = default(decimal?), string name = default(string), string optionType = default(string), decimal? pointValue = default(decimal?), string root = default(string), string sectorName = default(string), decimal? strikePrice = default(decimal?), string underlying = default(string))
        {
            // to ensure "category" is required (not null)
            if (category == null)
            {
                throw new InvalidDataException("category is a required property for SymbolDefinition and cannot be null");
            }
            else
            {
            ...
            if (currency == null)
            {
                throw new InvalidDataException("currency is a required property for SymbolDefinition and cannot be null");
            }
            else
            {
            ...
            if (description == null)
            {
                throw new InvalidDataException("description is a required property for SymbolDefinition and cannot be null");
            }
            else
            {
            ...
            if (displayType == null)
            {
                throw new InvalidDataException("displayType is a required property for SymbolDefinition and cannot be null");
            }
            else
            {
            ...
            if (exchange == null)
            {
                throw new InvalidDataException("exchange is a required property for SymbolDefinition and cannot be null");
            }
            else
            {
            ...
            if (exchangeID == null)
            {
                throw new InvalidDataException("exchangeID is a required property for SymbolDefinition and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("expirationDate is a required property for SymbolDefinition and cannot be null");
            }
            else
            {
            ...
            if (futureType == null)
            {
                throw new InvalidDataException("futureType is a required property for SymbolDefinition and cannot be null");
            }
            else
            {
            ...
            if (lotSize == null)
            {
                throw new InvalidDataException("lotSize is a required property for SymbolDefinition and cannot be null");
            }
            else
            {
            ...
            if (minMove == null)
            {
                throw new InvalidDataException("minMove is a required property for SymbolDefinition and cannot be null");
            }
            else
            {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for SymbolDefinition and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (optionType == null)
            {
                throw new InvalidDataException("optionType is a required property for SymbolDefinition and cannot be null");
            }
            else
            {
            ...
            if (pointValue == null)
            {
                throw new InvalidDataException("pointValue is a required property for SymbolDefinition and cannot be null");
            }
            else
            {
            ...
            if (root == null)
            {
                throw new InvalidDataException("root is a required property for SymbolDefinition and cannot be null");
            }
            else
            {
                this.Root = root;
            ...
            if (strikePrice == null)
            {
                throw new InvalidDataException("strikePrice is a required property for SymbolDefinition and cannot be null");
            }
            else
            {
            ...
            if (underlying == null)
            {
                throw new InvalidDataException("underlying is a required property for SymbolDefinition and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SymbolDefinition {\n");
        ...
        {
            return this.Equals(input as SymbolDefinition);
        }

        /// <summary>
        /// Returns true if SymbolDefinition instances are equal
        /// </summary>
        /// <param name="input">Instance of SymbolDefinition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SymbolDefinition input)
        {
            if (input == null)
                return false;
