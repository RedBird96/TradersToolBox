...
namespace TradeStationAPI.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GroupOrderConfirmResponseDefinition : List<OrderConfirmResponseDefinition>,  IEquatable<GroupOrderConfirmResponseDefinition>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GroupOrderConfirmResponseDefinition" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public GroupOrderConfirmResponseDefinition() : base()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GroupOrderConfirmResponseDefinition {\n");
        ...
        {
            return this.Equals(input as GroupOrderConfirmResponseDefinition);
        }

        /// <summary>
        /// Returns true if GroupOrderConfirmResponseDefinition instances are equal
        /// </summary>
        /// <param name="input">Instance of GroupOrderConfirmResponseDefinition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GroupOrderConfirmResponseDefinition input)
        {
            if (input == null)
                return false;
