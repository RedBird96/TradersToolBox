...
namespace TradeStationAPI.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SymbolSearchDefinition : List<SymbolSearchDefinitionInner>,  IEquatable<SymbolSearchDefinition>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SymbolSearchDefinition" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public SymbolSearchDefinition() : base()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SymbolSearchDefinition {\n");
        ...
        {
            return this.Equals(input as SymbolSearchDefinition);
        }

        /// <summary>
        /// Returns true if SymbolSearchDefinition instances are equal
        /// </summary>
        /// <param name="input">Instance of SymbolSearchDefinition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SymbolSearchDefinition input)
        {
            if (input == null)
                return false;
