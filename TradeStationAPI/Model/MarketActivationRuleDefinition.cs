...
{
    /// <summary>
    /// Market Activation Rules that must be met before the order is sent to the exchange.
    /// </summary>
    [DataContract]
    public partial class MarketActivationRuleDefinition :  IEquatable<MarketActivationRuleDefinition>, IValidatableObject
    {
        /// <summary>
        /// Type of the activation rule. Currently only support \&quot;Price\&quot; 
        /// </summary>
        /// <value>Type of the activation rule. Currently only support \&quot;Price\&quot; </value>
        ...
        /// </summary>
        /// <value>The predicate comparison for the market rule type. E.g. Lt (less than). </value>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// </summary>
        /// <value>The ticks behavior for the activation rule. </value>
        [JsonConverter(typeof(StringEnumConverter))]
        public enum TriggerKeyEnum
        {
            ...
            /// <summary>
            /// Enum STTN for value: STTN
            /// </summary>
            [EnumMember(Value = "STTN")]
            STTN = 2,
            
            /// <summary>
            /// Enum SBA for value: SBA
            /// </summary>
            [EnumMember(Value = "SBA")]
            SBA = 3,
            
            /// <summary>
            /// Enum SAB for value: SAB
            /// </summary>
            [EnumMember(Value = "SAB")]
            SAB = 4,
            
            /// <summary>
            /// Enum DTT for value: DTT
            /// </summary>
            [EnumMember(Value = "DTT")]
            DTT = 5,
            
            /// <summary>
            /// Enum DTTN for value: DTTN
            /// </summary>
            [EnumMember(Value = "DTTN")]
            DTTN = 6,
            ...
            /// <summary>
            /// Enum DAB for value: DAB
            /// </summary>
            [EnumMember(Value = "DAB")]
            DAB = 8,
            
            /// <summary>
            /// Enum TTT for value: TTT
            /// </summary>
            [EnumMember(Value = "TTT")]
            TTT = 9,
            
            /// <summary>
            /// Enum TTTN for value: TTTN
            /// </summary>
            [EnumMember(Value = "TTTN")]
            TTTN = 10,
        ...
        /// </summary>
        /// <value>The ticks behavior for the activation rule. </value>
        [DataMember(Name="TriggerKey", EmitDefaultValue=false)]
        public TriggerKeyEnum? TriggerKey { get; set; }
        /// <summary>
        ...
        /// </summary>
        /// <value>Relation with the previous activation rule when given a list of MarketActivationRules. Ignored for the first MarketActivationRule. </value>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// </summary>
        /// <value>Relation with the previous activation rule when given a list of MarketActivationRules. Ignored for the first MarketActivationRule. </value>
        [DataMember(Name="LogicOperator", EmitDefaultValue=false)]
        public LogicOperatorEnum? LogicOperator { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="MarketActivationRuleDefinition" /> class.
        /// </summary>
        /// <param name="ruleType">Type of the activation rule. Currently only support \&quot;Price\&quot; .</param>
        /// <param name="symbol">Symbol that the rule is based on .</param>
        /// <param name="predicate">The predicate comparison for the market rule type. E.g. Lt (less than). .</param>
        /// <param name="triggerKey">The ticks behavior for the activation rule. .</param>
        /// <param name="price">Valid only for Type&#x3D;\&quot;Price\&quot;, the price at which the rule will trigger when the price hits ticks as specified by TriggerType .</param>
        /// <param name="logicOperator">Relation with the previous activation rule when given a list of MarketActivationRules. Ignored for the first MarketActivationRule. .</param>
        public MarketActivationRuleDefinition(RuleTypeEnum? ruleType = default(RuleTypeEnum?), string symbol = default(string), PredicateEnum? predicate = default(PredicateEnum?), TriggerKeyEnum? triggerKey = default(TriggerKeyEnum?), string price = default(string), LogicOperatorEnum? logicOperator = default(LogicOperatorEnum?))
        {
        ...
        /// </summary>
        /// <value>Symbol that the rule is based on </value>
        ...
        /// </summary>
        /// <value>Valid only for Type&#x3D;\&quot;Price\&quot;, the price at which the rule will trigger when the price hits ticks as specified by TriggerType </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MarketActivationRuleDefinition {\n");
        ...
        {
            return this.Equals(input as MarketActivationRuleDefinition);
        }

        /// <summary>
        /// Returns true if MarketActivationRuleDefinition instances are equal
        /// </summary>
        /// <param name="input">Instance of MarketActivationRuleDefinition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MarketActivationRuleDefinition input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    ...
                    this.TriggerKey.Equals(input.TriggerKey))
                ) && 
                (
                ...
                (
                    this.LogicOperator == input.LogicOperator ||
                    (this.LogicOperator != null &&
                    this.LogicOperator.Equals(input.LogicOperator))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.TriggerKey != null)
                    hashCode = hashCode * 59 + this.TriggerKey.GetHashCode();
                if (this.Price != null)
                    hashCode = hashCode * 59 + this.Price.GetHashCode();
                if (this.LogicOperator != null)
                    hashCode = hashCode * 59 + this.LogicOperator.GetHashCode();
                return hashCode;
            }
        }
