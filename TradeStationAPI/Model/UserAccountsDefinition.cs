...
namespace TradeStationAPI.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UserAccountsDefinition : List<UserAccountsDefinitionInner>,  IEquatable<UserAccountsDefinition>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UserAccountsDefinition" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public UserAccountsDefinition() : base()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UserAccountsDefinition {\n");
        ...
        {
            return this.Equals(input as UserAccountsDefinition);
        }

        /// <summary>
        /// Returns true if UserAccountsDefinition instances are equal
        /// </summary>
        /// <param name="input">Instance of UserAccountsDefinition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserAccountsDefinition input)
        {
            if (input == null)
                return false;
