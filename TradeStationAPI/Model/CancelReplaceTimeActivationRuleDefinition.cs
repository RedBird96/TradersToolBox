...
namespace TradeStationAPI.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CancelReplaceTimeActivationRuleDefinition :  IEquatable<CancelReplaceTimeActivationRuleDefinition>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CancelReplaceTimeActivationRuleDefinition" /> class.
        /// </summary>
        ...
        /// <param name="rules">Set of time-based activation rules that must be met before order is sent to the exchange. Max 1 rule. .</param>
        public CancelReplaceTimeActivationRuleDefinition(bool? clearAll = default(bool?), List<TimeActivationRuleDefinition> rules = default(List<TimeActivationRuleDefinition>))
        {
        ...
        public List<TimeActivationRuleDefinition> Rules { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CancelReplaceTimeActivationRuleDefinition {\n");
        ...
        {
            return this.Equals(input as CancelReplaceTimeActivationRuleDefinition);
        }

        /// <summary>
        /// Returns true if CancelReplaceTimeActivationRuleDefinition instances are equal
        /// </summary>
        /// <param name="input">Instance of CancelReplaceTimeActivationRuleDefinition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CancelReplaceTimeActivationRuleDefinition input)
        {
            if (input == null)
                return false;
