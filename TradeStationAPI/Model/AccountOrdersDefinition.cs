...
namespace TradeStationAPI.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AccountOrdersDefinition : List<AccountOrdersDefinitionInner>,  IEquatable<AccountOrdersDefinition>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountOrdersDefinition" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public AccountOrdersDefinition() : base()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccountOrdersDefinition {\n");
        ...
        {
            return this.Equals(input as AccountOrdersDefinition);
        }

        /// <summary>
        /// Returns true if AccountOrdersDefinition instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountOrdersDefinition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountOrdersDefinition input)
        {
            if (input == null)
                return false;
