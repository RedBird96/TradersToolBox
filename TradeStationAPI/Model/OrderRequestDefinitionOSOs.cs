...
namespace TradeStationAPI.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OrderRequestDefinitionOSOs :  IEquatable<OrderRequestDefinitionOSOs>, IValidatableObject
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OrderRequestDefinitionOSOs" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected OrderRequestDefinitionOSOs() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OrderRequestDefinitionOSOs" /> class.
        /// </summary>
        /// <param name="type">type (required).</param>
        /// <param name="orders">orders.</param>
        public OrderRequestDefinitionOSOs(TypeEnum type = default(TypeEnum), List<OrderRequestDefinition> orders = default(List<OrderRequestDefinition>))
        {
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for OrderRequestDefinitionOSOs and cannot be null");
            }
            else
            {
                this.Type = type;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OrderRequestDefinitionOSOs {\n");
        ...
        {
            return this.Equals(input as OrderRequestDefinitionOSOs);
        }

        /// <summary>
        /// Returns true if OrderRequestDefinitionOSOs instances are equal
        /// </summary>
        /// <param name="input">Instance of OrderRequestDefinitionOSOs to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrderRequestDefinitionOSOs input)
        {
            if (input == null)
                return false;
