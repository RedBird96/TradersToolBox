...
namespace TradeStationAPI.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AccountBalancesDefinition : List<AccountBalancesDefinitionInner>,  IEquatable<AccountBalancesDefinition>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountBalancesDefinition" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public AccountBalancesDefinition() : base()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccountBalancesDefinition {\n");
        ...
        {
            return this.Equals(input as AccountBalancesDefinition);
        }

        /// <summary>
        /// Returns true if AccountBalancesDefinition instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountBalancesDefinition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountBalancesDefinition input)
        {
            if (input == null)
                return false;
