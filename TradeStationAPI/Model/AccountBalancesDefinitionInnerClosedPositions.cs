...
{
    /// <summary>
    /// AccountBalancesDefinitionInnerClosedPositions
    /// </summary>
    [DataContract]
    public partial class AccountBalancesDefinitionInnerClosedPositions :  IEquatable<AccountBalancesDefinitionInnerClosedPositions>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountBalancesDefinitionInnerClosedPositions" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AccountBalancesDefinitionInnerClosedPositions() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountBalancesDefinitionInnerClosedPositions" /> class.
        /// </summary>
        /// <param name="currency">The base currency of the symbol. (required).</param>
        /// <param name="profit">This value includes any gain or loss as a result of closing a position. (required).</param>
        /// <param name="symbol">The name identifying the financial instrument for which the data is displayed. (required).</param>
        public AccountBalancesDefinitionInnerClosedPositions(decimal? currency = default(decimal?), decimal? profit = default(decimal?), string symbol = default(string))
        {
            // to ensure "currency" is required (not null)
            if (currency == null)
            {
                throw new InvalidDataException("currency is a required property for AccountBalancesDefinitionInnerClosedPositions and cannot be null");
            }
            else
            {
            ...
            if (profit == null)
            {
                throw new InvalidDataException("profit is a required property for AccountBalancesDefinitionInnerClosedPositions and cannot be null");
            }
            else
            {
                this.Profit = profit;
            ...
            if (symbol == null)
            {
                throw new InvalidDataException("symbol is a required property for AccountBalancesDefinitionInnerClosedPositions and cannot be null");
            }
            else
            {
                this.Symbol = symbol;
        ...
        /// <summary>
        /// This value includes any gain or loss as a result of closing a position.
        /// </summary>
        /// <value>This value includes any gain or loss as a result of closing a position.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccountBalancesDefinitionInnerClosedPositions {\n");
        ...
        {
            return this.Equals(input as AccountBalancesDefinitionInnerClosedPositions);
        }

        /// <summary>
        /// Returns true if AccountBalancesDefinitionInnerClosedPositions instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountBalancesDefinitionInnerClosedPositions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountBalancesDefinitionInnerClosedPositions input)
        {
            if (input == null)
                return false;
