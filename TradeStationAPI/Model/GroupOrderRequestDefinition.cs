...
namespace TradeStationAPI.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GroupOrderRequestDefinition :  IEquatable<GroupOrderRequestDefinition>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GroupOrderRequestDefinition" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GroupOrderRequestDefinition() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GroupOrderRequestDefinition" /> class.
        /// </summary>
        ...
        public GroupOrderRequestDefinition(List<OrderRequestDefinition> orders = default(List<OrderRequestDefinition>), TypeEnum type = default(TypeEnum))
        {
            // to ensure "orders" is required (not null)
            if (orders == null)
            {
                throw new InvalidDataException("orders is a required property for GroupOrderRequestDefinition and cannot be null");
            }
            else
            {
                this.Orders = orders;
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for GroupOrderRequestDefinition and cannot be null");
            }
            else
            {
                this.Type = type;
        ...
        public List<OrderRequestDefinition> Orders { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GroupOrderRequestDefinition {\n");
        ...
        {
            return this.Equals(input as GroupOrderRequestDefinition);
        }

        /// <summary>
        /// Returns true if GroupOrderRequestDefinition instances are equal
        /// </summary>
        /// <param name="input">Instance of GroupOrderRequestDefinition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GroupOrderRequestDefinition input)
        {
            if (input == null)
                return false;
