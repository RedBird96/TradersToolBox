...
namespace TradeStationAPI.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SymbolListDefinition :  IEquatable<SymbolListDefinition>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SymbolListDefinition" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SymbolListDefinition() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SymbolListDefinition" /> class.
        /// </summary>
        /// <param name="category">Second Level of Symbol List Hierarchy. (required).</param>
        /// <param name="iD">Unique symbol list identifier. (required).</param>
        /// <param name="name">Symbol List Name. (required).</param>
        /// <param name="path">Full hierarchy path including name. (required).</param>
        /// <param name="rootCategory">First Level of Symbol List Hierarchy. (required).</param>
        /// <param name="subcategory">Thrid Level of Symbol List Hierarchy. (required).</param>
        public SymbolListDefinition(string category = default(string), string iD = default(string), string name = default(string), string path = default(string), string rootCategory = default(string), string subcategory = default(string))
        {
            // to ensure "category" is required (not null)
            if (category == null)
            {
                throw new InvalidDataException("category is a required property for SymbolListDefinition and cannot be null");
            }
            else
            {
            ...
            if (iD == null)
            {
                throw new InvalidDataException("iD is a required property for SymbolListDefinition and cannot be null");
            }
            else
            {
                this.ID = iD;
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for SymbolListDefinition and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (path == null)
            {
                throw new InvalidDataException("path is a required property for SymbolListDefinition and cannot be null");
            }
            else
            {
                this.Path = path;
            }
            // to ensure "rootCategory" is required (not null)
            if (rootCategory == null)
            {
                throw new InvalidDataException("rootCategory is a required property for SymbolListDefinition and cannot be null");
            }
            else
            {
            ...
            if (subcategory == null)
            {
                throw new InvalidDataException("subcategory is a required property for SymbolListDefinition and cannot be null");
            }
            else
            {
        ...
        /// <summary>
        /// Second Level of Symbol List Hierarchy.
        /// </summary>
        /// <value>Second Level of Symbol List Hierarchy.</value>
        [DataMember(Name="Category", EmitDefaultValue=false)]
        public string Category { get; set; }

        /// <summary>
        /// Unique symbol list identifier.
        /// </summary>
        /// <value>Unique symbol list identifier.</value>
        ...
        /// Symbol List Name.
        /// </summary>
        /// <value>Symbol List Name.</value>
        [DataMember(Name="Name", EmitDefaultValue=false)]
        public string Name { get; set; }

        /// <summary>
        /// Full hierarchy path including name.
        /// </summary>
        /// <value>Full hierarchy path including name.</value>
        [DataMember(Name="Path", EmitDefaultValue=false)]
        public string Path { get; set; }

        /// <summary>
        /// First Level of Symbol List Hierarchy.
        /// </summary>
        /// <value>First Level of Symbol List Hierarchy.</value>
        [DataMember(Name="RootCategory", EmitDefaultValue=false)]
        public string RootCategory { get; set; }

        /// <summary>
        /// Thrid Level of Symbol List Hierarchy.
        /// </summary>
        /// <value>Thrid Level of Symbol List Hierarchy.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SymbolListDefinition {\n");
            sb.Append("  Category: ").Append(Category).Append("\n");
            sb.Append("  ID: ").Append(ID).Append("\n");
            sb.Append("  Name: ").Append(Name).Append("\n");
            sb.Append("  Path: ").Append(Path).Append("\n");
            sb.Append("  RootCategory: ").Append(RootCategory).Append("\n");
        ...
        {
            return this.Equals(input as SymbolListDefinition);
        }

        /// <summary>
        /// Returns true if SymbolListDefinition instances are equal
        /// </summary>
        /// <param name="input">Instance of SymbolListDefinition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SymbolListDefinition input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.RootCategory == input.RootCategory ||
                    (this.RootCategory != null &&
                    this.RootCategory.Equals(input.RootCategory))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.RootCategory != null)
                    hashCode = hashCode * 59 + this.RootCategory.GetHashCode();
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // RootCategory (string) minLength
            if(this.RootCategory != null && this.RootCategory.Length < 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for RootCategory, length must be greater than 1.", new [] { "RootCategory" });
            }

            // Subcategory (string) minLength
            if(this.Subcategory != null && this.Subcategory.Length < 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for Subcategory, length must be greater than 1.", new [] { "Subcategory" });
            }
