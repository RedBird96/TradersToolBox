...
{
    /// <summary>
    /// OrderConfirmRequestDefinitionOSOs
    /// </summary>
    [DataContract]
    public partial class OrderConfirmRequestDefinitionOSOs :  IEquatable<OrderConfirmRequestDefinitionOSOs>, IValidatableObject
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OrderConfirmRequestDefinitionOSOs" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected OrderConfirmRequestDefinitionOSOs() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OrderConfirmRequestDefinitionOSOs" /> class.
        /// </summary>
        /// <param name="type">type (required).</param>
        /// <param name="orders">orders.</param>
        public OrderConfirmRequestDefinitionOSOs(TypeEnum type = default(TypeEnum), List<OrderConfirmRequestDefinition> orders = default(List<OrderConfirmRequestDefinition>))
        {
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for OrderConfirmRequestDefinitionOSOs and cannot be null");
            }
            else
            {
                this.Type = type;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OrderConfirmRequestDefinitionOSOs {\n");
        ...
        {
            return this.Equals(input as OrderConfirmRequestDefinitionOSOs);
        }

        /// <summary>
        /// Returns true if OrderConfirmRequestDefinitionOSOs instances are equal
        /// </summary>
        /// <param name="input">Instance of OrderConfirmRequestDefinitionOSOs to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrderConfirmRequestDefinitionOSOs input)
        {
            if (input == null)
                return false;
