...
namespace TradeStationAPI.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AdvancedOptionsDefinition :  IEquatable<AdvancedOptionsDefinition>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AdvancedOptionsDefinition" /> class.
        /// </summary>
        /// <param name="trailingStop">trailingStop.</param>
        /// <param name="marketActivationRules">Set of market-based activation rules that must be met before order is sent to the exchange. Max 4 rules. .</param>
        /// <param name="timeActivationRules">Set of time-based activation rules that must be met before order is sent to the exchange. Max 1 rule. .</param>
        /// <param name="showOnlyQuantity">Number of shares to submit to market at a time for this order. Valid for futures and equities orders. For equities, must be multiple of 100. .</param>
        public AdvancedOptionsDefinition(TrailingStopDefinition trailingStop = default(TrailingStopDefinition), List<MarketActivationRuleDefinition> marketActivationRules = default(List<MarketActivationRuleDefinition>), List<TimeActivationRuleDefinition> timeActivationRules = default(List<TimeActivationRuleDefinition>), int? showOnlyQuantity = default(int?))
        {
        ...
        /// </summary>
        /// <value>Set of market-based activation rules that must be met before order is sent to the exchange. Max 4 rules. </value>
        ...
        /// </summary>
        /// <value>Set of time-based activation rules that must be met before order is sent to the exchange. Max 1 rule. </value>
        ...
        /// </summary>
        /// <value>Number of shares to submit to market at a time for this order. Valid for futures and equities orders. For equities, must be multiple of 100. </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AdvancedOptionsDefinition {\n");
        ...
        {
            return this.Equals(input as AdvancedOptionsDefinition);
        }

        /// <summary>
        /// Returns true if AdvancedOptionsDefinition instances are equal
        /// </summary>
        /// <param name="input">Instance of AdvancedOptionsDefinition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AdvancedOptionsDefinition input)
        {
            if (input == null)
                return false;
