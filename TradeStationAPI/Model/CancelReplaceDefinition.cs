...
namespace TradeStationAPI.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CancelReplaceDefinition :  IEquatable<CancelReplaceDefinition>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CancelReplaceDefinition" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CancelReplaceDefinition() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CancelReplaceDefinition" /> class.
        /// </summary>
        ...
        public CancelReplaceDefinition(string limitPrice = default(string), string stopPrice = default(string), string orderType = default(string), string quantity = default(string), string symbol = default(string), CancelReplaceAdvancedOptionsDefinition advancedOptions = default(CancelReplaceAdvancedOptionsDefinition))
        {
            // to ensure "orderType" is required (not null)
            if (orderType == null)
            {
                throw new InvalidDataException("orderType is a required property for CancelReplaceDefinition and cannot be null");
            }
            else
            {
            ...
            if (quantity == null)
            {
                throw new InvalidDataException("quantity is a required property for CancelReplaceDefinition and cannot be null");
            }
            else
            {
            ...
            if (symbol == null)
            {
                throw new InvalidDataException("symbol is a required property for CancelReplaceDefinition and cannot be null");
            }
            else
            {
                this.Symbol = symbol;
        ...
        public CancelReplaceAdvancedOptionsDefinition AdvancedOptions { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CancelReplaceDefinition {\n");
        ...
        {
            return this.Equals(input as CancelReplaceDefinition);
        }

        /// <summary>
        /// Returns true if CancelReplaceDefinition instances are equal
        /// </summary>
        /// <param name="input">Instance of CancelReplaceDefinition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CancelReplaceDefinition input)
        {
            if (input == null)
                return false;
