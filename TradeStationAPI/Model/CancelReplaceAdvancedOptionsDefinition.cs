...
namespace TradeStationAPI.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CancelReplaceAdvancedOptionsDefinition :  IEquatable<CancelReplaceAdvancedOptionsDefinition>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CancelReplaceAdvancedOptionsDefinition" /> class.
        /// </summary>
        ...
        /// <param name="showOnlyQuantity">Number of shares to submit to market at a time for this order. Valid for futures and equities orders. For equities, must be multiple of 100. Cannot be added if original order did not have ShowOnlyQuantity. .</param>
        public CancelReplaceAdvancedOptionsDefinition(TrailingStopDefinition trailingStop = default(TrailingStopDefinition), CancelReplaceMarketActivationRuleDefinition marketActivationRules = default(CancelReplaceMarketActivationRuleDefinition), CancelReplaceTimeActivationRuleDefinition timeActivationRules = default(CancelReplaceTimeActivationRuleDefinition), int? showOnlyQuantity = default(int?))
        {
        ...
        public CancelReplaceMarketActivationRuleDefinition MarketActivationRules { get; set; }

        /// <summary>
        /// Gets or Sets TimeActivationRules
        /// </summary>
        [DataMember(Name="TimeActivationRules", EmitDefaultValue=false)]
        public CancelReplaceTimeActivationRuleDefinition TimeActivationRules { get; set; }

        /// <summary>
        /// Number of shares to submit to market at a time for this order. Valid for futures and equities orders. For equities, must be multiple of 100. Cannot be added if original order did not have ShowOnlyQuantity. 
        /// </summary>
        /// <value>Number of shares to submit to market at a time for this order. Valid for futures and equities orders. For equities, must be multiple of 100. Cannot be added if original order did not have ShowOnlyQuantity. </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CancelReplaceAdvancedOptionsDefinition {\n");
        ...
        {
            return this.Equals(input as CancelReplaceAdvancedOptionsDefinition);
        }

        /// <summary>
        /// Returns true if CancelReplaceAdvancedOptionsDefinition instances are equal
        /// </summary>
        /// <param name="input">Instance of CancelReplaceAdvancedOptionsDefinition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CancelReplaceAdvancedOptionsDefinition input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    ...
                    this.MarketActivationRules.Equals(input.MarketActivationRules))
                ) && 
                (
                    this.TimeActivationRules == input.TimeActivationRules ||
                    (this.TimeActivationRules != null &&
                    this.TimeActivationRules.Equals(input.TimeActivationRules))
                ) && 
                (
        ...
        {
            // ShowOnlyQuantity (int?) minimum
            if(this.ShowOnlyQuantity < (int?)0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for ShowOnlyQuantity, must be a value greater than or equal to 0.", new [] { "ShowOnlyQuantity" });
            }
