...
{
    /// <summary>
    /// Time Activation Rules that must be met before the order is sent to the exchange.
    /// </summary>
    [DataContract]
    public partial class TimeActivationRuleDefinition :  IEquatable<TimeActivationRuleDefinition>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TimeActivationRuleDefinition" /> class.
        /// </summary>
        /// <param name="timeUtc">Order is activated once current UTC time is greater thans or equal to TimeUtc. hh:mm:ss .</param>
        public TimeActivationRuleDefinition(string timeUtc = default)
        {
        ...
        /// </summary>
        /// <value>Order is activated once current UTC time is greater thans or equal to TimeUtc. hh:mm:ss </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TimeActivationRuleDefinition {\n");
        ...
        {
            return this.Equals(input as TimeActivationRuleDefinition);
        }

        /// <summary>
        /// Returns true if TimeActivationRuleDefinition instances are equal
        /// </summary>
        /// <param name="input">Instance of TimeActivationRuleDefinition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TimeActivationRuleDefinition input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.TimeUtc == input.TimeUtc ||
                    (this.TimeUtc != null &&
                    this.TimeUtc.Equals(input.TimeUtc))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.TimeUtc != null)
                    hashCode = hashCode * 59 + this.TimeUtc.GetHashCode();
                return hashCode;
            }
        }
